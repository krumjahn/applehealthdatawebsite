...
var remove2 = /* @__PURE__ */ __name((prev, current, next2) => {
...
var is2 = /* @__PURE__ */ __name((next2, token, options, context, compileToken2) => {
...
var matches = /* @__PURE__ */ __name((element, selectors) => is3(
  element,
  selectors,
  {
    strict: true,
...
var isNode = /* @__PURE__ */ __name((node) => node instanceof Node3, "isNode");
...
var isVoid2 = /* @__PURE__ */ __name(({ localName, ownerDocument }) => {
...
var voidElements3 = { test: /* @__PURE__ */ __name(() => true, "test") };
var Mime = {
  "text/html": {
...
async function handleProxy(request, url) {
  ...
  if (isHtml && wantsMarkdown) {
    ...
    if (html) {
      const { document: document2, DOMParser: DOMParser2, Node: Node5 } = parseHTML(html);
      const td = new TurndownService({ headingStyle: "atx", codeBlockStyle: "fenced" });
      const markdown = td.turndown(document2.body || html);
